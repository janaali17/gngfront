const products = [
    // Moisturizer (Expanded combinations)
    ...
    { name: "CeraVe Moisturizer", ageGroup: "Above 45", skinType: "Sensitive", priceRange: "$20-$50", productType: "Moisturizer" },
    { name: "Neutrogena Moisturizer", ageGroup: "18-25", skinType: "Combination", priceRange: "$10-$20", productType: "Moisturizer" },
  
    // Serum (Expanded combinations)
    ...
    { name: "The Ordinary Serum", ageGroup: "Below 18", skinType: "Combination", priceRange: "$10-$20", productType: "Serum" },
  
    // Sunscreen (Expanded combinations)
    ...
    { name: "CeraVe Sunscreen", ageGroup: "26-35", skinType: "Combination", priceRange: "$20-$50", productType: "Sunscreen" },
  
    // Cleanser (Expanded combinations)
    ...
    { name: "Glow Recipe Cleanser", ageGroup: "Below 18", skinType: "Combination", priceRange: "$10-$20", productType: "Cleanser" },
    { name: "The Ordinary Cleanser", ageGroup: "18-25", skinType: "Sensitive", priceRange: "$50-$100", productType: "Cleanser" },
